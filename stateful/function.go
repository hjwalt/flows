...
type ErrorHandlerFunction func(context.Context, flow.Message[structure.Bytes, structure.Bytes], State[structure.Bytes], error) ([]flow.Message[structure.Bytes, structure.Bytes], State[structure.Bytes], error)
